  ...
  return (
    <div className="mt-0 p-4 md:p-5 md:pl-7 space-y-5 max-w-[55rem] mx-auto md:mx-0">
      ...
      <div className="border border-gray-200 rounded-md p-4 md:p-5 h-72 md:h-80 overflow-y-auto text-xs md:text-sm space-y-3 scroll-thin leading-relaxed">
        ...
        <p>
          <span className="skew-x-[-8deg] inline-block text-sm text-gray-600">
        ...
        <p className="font-semibold text-sm mt-4">1. Ruang Lingkup Layanan</p>
        <p>
        ...
        <p className="font-semibold text-sm mt-4">3. Pembayaran</p>
        <p>
        ...
        <p className="font-semibold text-sm mt-4">5. Akses dan Masa Berlaku</p>
        <p>
        ...
        <p className="font-semibold text-sm mt-4">6. Penjadwalan Ulang</p>
        <p>
        ...
        <p className="font-semibold text-sm mt-4">13. Hukum yang Berlaku</p>
        <p>
        ...
        <p className="font-semibold text-sm mt-4">14. Persetujuan</p>
        <p className="font-medium">
