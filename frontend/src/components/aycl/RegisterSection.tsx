...
export default function RegisterSection({
  ...
  return (
    <section
      id="daftar"
      className="py-20 px-4 bg-gradient-to-br from-emerald-600 to-emerald-700"
    >
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-emerald-100 font-medium text-sm md:text-base mb-10 leading-relaxed">
        ...
        {loadingUser ? (
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 text-center shadow-xl">
            ...
            <button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2.5 rounded-lg text-sm font-semibold shadow-sm"
            >
              Login Sekarang
            </button>
          </div>
        ) : (
          <div className="bg-white rounded-2xl p-6 md:p-8 text-left shadow-xl">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  disabled={submitting}
                  className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-800 focus:ring-2 focus:ring-emerald-400 disabled:bg-gray-50 disabled:cursor-not-allowed"
                />
              </div>
            ...
            <button
              ...
              disabled={submitting}
              className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-lg text-sm shadow-sm transition-colors"
            >
