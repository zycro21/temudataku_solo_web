            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-8 md:mb-16">
                    ...
                    <p className="text-base md:text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed px-4">
                        Bukan sekadar latihan—ini hasil nyata dari mereka yang
                        udah serius ngejalanin challenge di TemuDataku. Dari
                        analisis data sampai visualisasi yang insight-driven,
                        semua project ini nunjukin gimana latihan bisa beneran
                        ngasah skill. Siap-siap terinspirasi!
                    </p>
                </div>
                                ...
                                >
                                    <div className="bg-bg-color-primary rounded-lg md:rounded-xl overflow-hidden h-full flex flex-col">
                                        ...
                                        <div className="relative h-48 sm:h-56 md:h-64 lg:h-72 bg-gradient-to-br from-blue-50 to-indigo-100 flex-shrink-0">
                                            <Image src="/assets/mentoringPage/laptop.svg" alt="laptop" width={400} height={300} className="w-full h-full object-cover" />
                                        </div>
