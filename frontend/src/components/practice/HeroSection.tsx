                    ...
                    <div className="space-y-6 order-1 lg:order-2">
                        ...
                        <div className="space-y-2">
                            <h1 className="text-xl md:text-2xl lg:text-4xl font-semibold text-gray-900 leading-tight">
                                Siap Level Up? Mulai Latihan <br /> Sekarang!
                            </h1>
                            ...
                            <p className="max-sm:text-sm text-md text-gray-600 leading-relaxed max-w-2xl">
                                Skill gak bakal naik level kalau cuma baca teori. Yuk, langsung praktik lewat latihan
                                interaktif yang dibuat khusus buat calon praktisi data kayak kamu.
                            </p>
                        </div>
