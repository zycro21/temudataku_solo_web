    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-4xl mx-auto px-1">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2.5 text-base sm:text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-gray-700"
                />
              </div>
            </div>
          </div>
                ...
                <Card className="group rounded-xl border border-gray-200 hover:shadow-lg transition-all p-0 cursor-pointer hover:-translate-y-1 duration-300">
                  ...
                  <CardContent className="p-4 pt-0">
                    ...
                    {(() => {
                      ...
                      // dua-duanya selalu konsisten (nggak ada kemungkinan
                      // beda hasil pembulatan kalau getDisplayedRating
                      // dipanggil terpisah di dua tempat).
