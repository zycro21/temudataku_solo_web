                    ...
                    <div className="space-y-6 order-1 lg:order-2">
                        ...
                        <div className="space-y-2">
                            <h1 className="text-xl md:text-2xl lg:text-4xl font-semibold text-gray-900 leading-tight">
                                Materi Terstruktur & Praktik Langsung dengan
                                Bootcamp
                            </h1>
                            ...
                            <p className="max-sm:text-sm text-md text-gray-600 leading-relaxed max-w-2xl">
                                Bootcamp TemuDataku dirancang buat kamu yang
                                pengen belajar data dari nol sampai paham, tanpa
                                pusing. Materinya udah disusun rapi dan langsung
                                dipraktikkin, jadi kamu nggak cuma belajar—tapi
                                juga beneran bisa!
                            </p>
                        </div>
