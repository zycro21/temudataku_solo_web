...
// import MentorStatCards from "@/components/dashboard/mentor/services/mentorStatCardSchedule";
      ...
      <div className="flex-1 flex flex-col ml-72">
        ...
        <main className="flex-1 p-6 pl-7 bg-gray-50 overflow-x-hidden">
          <div className="flex">
            ...
            <p>Detail Proyek Bootcamp Data Analyst</p>
          </div>
          ...
          <div className="max-w-[100%]">{/* <MentorStatCards /> */}</div>
        </main>
      </div>
    </div>
  );
