...
import type { PublishedCertificate } from "./columns";
import {
  flexRender,
  getCoreRowModel,
  getFilteredRowModel,
...
export function DataTable<TData, TValue>({
  ...
  const [selectedCertificate, setSelectedCertificate] =
    React.useState<PublishedCertificate | null>(null);
  ...
  const table = useReactTable({
    ...
    columns,
    meta: {
      onView: (item: PublishedCertificate) => {
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center pb-4">
          <div className="relative w-full max-w-md">
            ...
            <Input
              placeholder="Cari Sertifikat berdasarkan Nama atau Program..."
              value={globalFilter ?? ""}
        ...
        >
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="w-full h-48 bg-gray-200 rounded-md overflow-hidden relative">
                    <img
                      src={selectedCertificate.template}
                      alt="template"
          ...
          <DialogFooter className="flex space-x-4 px-6 py-6 sm:justify-center">
            <Button
              ...
              onClick={() => {
                console.log("Edit:", selectedCertificate);
            ...
            <Button
              ...
              className="flex-1"
              onClick={() => {
                console.log("Delete:", selectedCertificate);
                setShowDetailDialog(false);
              }}
            >
              Hapus
