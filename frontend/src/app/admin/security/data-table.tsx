            ...
            <div className="space-y-6 py-4">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">{selectedProject.submissionStatus}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 mb-1">Topik</p>
                  <p className="text-lg font-semibold text-gray-900">{selectedProject.reviewStatus}</p>
                </div>
              </div>
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select value={editFormData.submissionStatus} onValueChange={(value) => setEditFormData({ ...editFormData, submissionStatus: value })}>
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="Pilih Status" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="sudah dikumpulkan">Sudah Dikumpulkan</SelectItem>
                        <SelectItem value="belum dikumpulkan">Belum Dikumpulkan</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Mentee</label>
                    <Select value={editFormData.reviewStatus} onValueChange={(value) => setEditFormData({ ...editFormData, reviewStatus: value })}>
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="Pilih Status" />
                      </SelectTrigger>
                      <SelectContent>
