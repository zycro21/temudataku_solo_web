...
import articleContentRoutes from "./routes/article_content.route.js";
...
app.use("/api/articlecontent", articleContentRoutes);
app.use("/api/redeemCode", redeemCodeRoutes);
