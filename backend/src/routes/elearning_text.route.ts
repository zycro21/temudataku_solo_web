 ...
 *     description: Admin dapat menambahkan teks ke sub-bab mana pun. Mentor hanya bisa menambahkan ke course yang dia ampu.
 *     tags: [E-Learning Texts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         schema:
 *           type: string
 *         description: ID sub-bab tempat teks akan ditambahkan
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *               textContent:
 *                 type: string
 *                 description: Konten teks (bisa panjang tanpa batas)
 *                 example: "Artificial Intelligence (AI) adalah cabang ilmu komputer..."
 *     responses:
 *       201:
 ...
 *               textContent:
 *                 type: string
 *                 example: "Ini adalah materi awal tentang konsep dasar ML..."
 *               orderNumber:
 *                 type: integer
 *                 example: 2
 *     responses:
